      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-cosmiq-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-cosmiq-elements-item-backgroundAccent hover:bg-cosmiq-elements-artifacts-backgroundHover"
