      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-cosmiq-elements-textPrimary dark:text-cosmiq-elements-textPrimary-dark'
              : 'text-cosmiq-elements-textSecondary dark:text-cosmiq-elements-textSecondary-dark hover:text-cosmiq-elements-textPrimary dark:hover:text-cosmiq-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-cosmiq-elements-textTertiary dark:text-cosmiq-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
