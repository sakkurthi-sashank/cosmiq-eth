  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-cosmiq-elements-borderColor bg-cosmiq-elements-background-depth-1 text-cosmiq-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-cosmiq-elements-textSecondary', className)} {...props} />;
  },
);
