      ...
      <div className={classNames('relative flex items-center w-full', containerClassName)}>
        ...
        <div
          className={classNames(
            'absolute left-3 top-1/2 -translate-y-1/2 text-cosmiq-elements-textTertiary',
            iconClassName,
          )}
        >
          {loading ? (
        ...
        <AnimatePresence>
          {hasValue && showClearButton && (
            <motion.button
              ...
              type="button"
              onClick={onClear}
              className="absolute right-3 top-1/2 -translate-y-1/2 text-cosmiq-elements-textTertiary hover:text-cosmiq-elements-textSecondary p-1 rounded-full hover:bg-cosmiq-elements-background-depth-2"
