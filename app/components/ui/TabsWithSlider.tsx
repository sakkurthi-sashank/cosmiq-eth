        ...
        <button
          ...
          className={classNames(
            ...
            tab.id === activeTab
              ...
              : classNames(
                  'bg-cosmiq-elements-background-depth-2 dark:bg-cosmiq-elements-background-depth-3 text-cosmiq-elements-textPrimary dark:text-cosmiq-elements-textPrimary-dark hover:bg-cosmiq-elements-background-depth-3 dark:hover:bg-cosmiq-elements-background-depth-4 border border-cosmiq-elements-borderColor dark:border-cosmiq-elements-borderColor-dark',
                  tabClassName,
                ),
          )}
        >
