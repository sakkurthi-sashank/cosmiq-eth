...
const storedProfile = typeof window !== 'undefined' ? localStorage.getItem('cosmiq_profile') : null;
...
export const updateProfile = (updates: Partial<Profile>) => {
  ...
  if (typeof window !== 'undefined') {
    localStorage.setItem('cosmiq_profile', JSON.stringify(profileStore.get()));
  }
};
